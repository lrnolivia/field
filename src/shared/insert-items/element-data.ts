...
const BACKGROUND_ITEMS: InsertItem[] = [
  ...
  { id: 'cs-bgSilk', name: 'Silk', iconKey: 'bgSilk', gradientColors: ['#0b0b14', '#f5c8e4'] },
  { id: 'cs-bgLightPillar', name: 'Light Pillar', iconKey: 'bgLightPillar', gradientColors: ['#07060f', '#7c3aed'] },
  { id: 'cs-bgIridescence', name: 'Iridescence', iconKey: 'bgIridescence', gradientColors: ['#08070d', '#22d3ee'] },
  { id: 'cs-bgGodRays', name: 'God Rays', iconKey: 'bgGodRays', gradientColors: ['#0a0806', '#ffd9a0'] },
  { id: 'cs-bgGrainField', name: 'Grain Field', iconKey: 'bgGrainField', gradientColors: ['#1b1035', '#f5b942'] },
  { id: 'cs-bgNebula', name: 'Nebula', iconKey: 'bgNebula', gradientColors: ['#04030a', '#d94fa0'] },
  { id: 'cs-bgDotWave', name: 'Dot Wave', iconKey: 'bgDotWave', gradientColors: ['#05070f', '#67e8f9'] },
  { id: 'cs-bgContours', name: 'Contours', iconKey: 'bgContours', gradientColors: ['#050810', '#a855f7'] },
  { id: 'cs-bgFluidGradient', name: 'Fluid Gradient', iconKey: 'bgFluidGradient', gradientColors: ['#1e1b4b', '#ec4899'] },
  { id: 'cs-bgCyberGrid', name: 'Cyber Grid', iconKey: 'bgCyberGrid', gradientColors: ['#0a0418', '#ff2fb9'] },
  { id: 'cs-bgRippleGrid', name: 'Ripple Grid', iconKey: 'bgRippleGrid', gradientColors: ['#04040c', '#22d3ee'] },
  { id: 'cs-bgVoronoiCells', name: 'Voronoi Cells', iconKey: 'bgVoronoi', gradientColors: ['#0f172a', '#67e8f9'] },
  { id: 'cs-bgMetaballField', name: 'Metaball Field', iconKey: 'bgMetaballField', gradientColors: ['#06060f', '#7c3aed'] },
  { id: 'cs-bgHalftoneScreen', name: 'Halftone Screen', iconKey: 'bgHalftoneScreen', gradientColors: ['#0c0a09', '#f43f5e'] },
  { id: 'cs-bgScanlineCRT', name: 'CRT', iconKey: 'bgCrt', gradientColors: ['#05070a', '#a3e635'] },
  { id: 'cs-bgSmoke', name: 'Smoke', iconKey: 'bgSmoke', gradientColors: ['#08080b', '#e4e4e7'] },
  { id: 'cs-bgMarble', name: 'Marble', iconKey: 'bgMarble', gradientColors: ['#0b1020', '#e2c887'] },
  { id: 'cs-bgWarpTunnel', name: 'Warp Tunnel', iconKey: 'bgWarpTunnel', gradientColors: ['#03030a', '#22d3ee'] },
  { id: 'cs-bgStarWarp', name: 'Star Warp', iconKey: 'bgStarWarp', gradientColors: ['#02030a', '#93c5fd'] },
  { id: 'cs-bgHexGrid', name: 'Hex Grid', iconKey: 'bgHexGrid', gradientColors: ['#04060e', '#a855f7'] },
  { id: 'cs-bgLightning', name: 'Lightning', iconKey: 'bgLightning', gradientColors: ['#05040d', '#8b5cf6'] },
  { id: 'cs-bgLiquidChrome', name: 'Liquid Chrome', iconKey: 'bgLiquidChrome', gradientColors: ['#0b0f1a', '#cbd5e1'] },
  { id: 'cs-bgBokeh', name: 'Bokeh', iconKey: 'bgBokeh', gradientColors: ['#07060e', '#f9a8d4'] },
  { id: 'cs-bgRainGlass', name: 'Rain Glass', iconKey: 'bgRainGlass', gradientColors: ['#050a10', '#67e8f9'] },
  { id: 'cs-bgFireflies', name: 'Fireflies', iconKey: 'bgFireflies', gradientColors: ['#050806', '#fde68a'] },
  { id: 'cs-bgVortex', name: 'Vortex', iconKey: 'bgVortex', gradientColors: ['#04030b', '#f472b6'] },
  { id: 'cs-bgSunset', name: 'Sunset', iconKey: 'bgSunset', gradientColors: ['#1e1b4b', '#f97316'] },
  { id: 'cs-bgDunes', name: 'Dunes', iconKey: 'bgDunes', gradientColors: ['#7c2d12', '#fed7aa'] },
  { id: 'cs-bgOilSlick', name: 'Oil Slick', iconKey: 'bgOilSlick', gradientColors: ['#05060a', '#a855f7'] },
  { id: 'cs-bgWaveStack', name: 'Wave Stack', iconKey: 'bgWaveStack', gradientColors: ['#020617', '#a5f3fc'] },
];
