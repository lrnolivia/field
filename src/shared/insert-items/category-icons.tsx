...
// Minimal UI: the per-category `bg` colours are ignored — every tile is a neutral
// token surface with its white glyph. (`bg` kept in the signature so call sites don't change.)
function CategorySquare({ children }: { bg?: string; children: React.ReactNode }) {
  return (
    <div
